...
from app.core.security_init import initialize_security, cleanup_security
...
app = FastAPI(
    ...
    description="Samoey Copilot - AI-Powered Development Assistant",
...
async def root():
    return {
        "message": "Welcome to Samoey Copilot API",
        "version": settings.VERSION,
        "docs": "/docs",
        "redoc": "/redoc"
    }
